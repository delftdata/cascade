# from cascade.frontend.generator.split_function import LocalBlock, SplitFunction
...
#     @classmethod
#     def generate(cls, split_functions: list[SplitFunction], instance_type_map: dict[str, str], method_name, op_name, args) -> tuple[DataFlow, list[LocalBlock]]:
